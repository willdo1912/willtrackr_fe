...
const StyleTest = () => {
  return (
    <div className="flex h-dvh w-full flex-col">
      ...
      <div className="size-full bg-main-pink dark:bg-main-dark-pink">
      ...
      <div className="size-full bg-main-teal dark:bg-main-dark-teal">
      ...
      <div className="size-full bg-main-blue dark:bg-main-dark-blue">
